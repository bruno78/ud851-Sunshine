...
//      COMPLETED (6) Move the cursor to the appropriate position
        ...
        long dateInMs = (long) mCursor.getLong(MainActivity.INDEX_WEATHER_DATE);
        String date = SunshineDateUtils.getFriendlyDateString(mContext, dateInMs, false);
...
//  COMPLETED (11) Create a new method that allows you to swap Cursors.
    ...
    class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            mClickHandler.onClick((String)(weatherSummary.getText()).toString());
        }
    }
}