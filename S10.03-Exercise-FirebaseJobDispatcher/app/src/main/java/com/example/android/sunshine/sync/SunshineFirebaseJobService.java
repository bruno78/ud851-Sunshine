...
public class SunshineFirebaseJobService extends JobService {
    ...
    private AsyncTask<Void, Void, Void> mFetchWatherTask;
    ...
    public boolean onStartJob(final JobParameters job) {
        ...
        mFetchWatherTask = new AsyncTask<Void, Void, Void>() {
            @Override
    ...
    public boolean onStopJob(JobParameters job) {
        if(mFetchWatherTask != null) {
            mFetchWatherTask.cancel(true);
        }
        return true;
    }
}
