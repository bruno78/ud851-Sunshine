...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData() {
        String queryLocation = SunshinePreferences.getPreferredWeatherLocation(this);
        new FetchWeatherTask().execute(queryLocation);
    }
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPostExecute(String[] forecastData) {
            ...
            if(forecastData != null && !forecastData.equals("")) {

                for( String weatherString : forecastData) {
