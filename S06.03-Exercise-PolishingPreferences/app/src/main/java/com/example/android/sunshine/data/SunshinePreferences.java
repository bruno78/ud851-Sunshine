...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        String defaultLocaion = context.getString(R.string.pref_location_default);
        return prefs.getString(keyForLocation, defaultLocaion);
    }
    ...
    public static boolean isMetric(Context context) {
        ...
        userPrefersMetric = metric.equals(preferredUnits)? true : false;
