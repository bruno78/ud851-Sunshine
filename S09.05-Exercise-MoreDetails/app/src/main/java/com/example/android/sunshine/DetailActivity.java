...
//  COMPLETED (19) Create constant int values representing each column name's position above
    ...
    public static final int INDEX_WEATHER_DEGREE = 6;
...
//      COMPLETED (13) Find each of the TextViews by ID
        ...
        mHighView = (TextView) findViewById(R.id.tv_weather_high_temp);
        mLowView = (TextView) findViewById(R.id.tv_weather_low_temp);
...
//      COMPLETED (26) Display a readable data string
        long dateLong = cursor.getLong(INDEX_WEATHER_DATE);
        String date = SunshineDateUtils.getFriendlyDateString(this, dateLong, true);
...
//      COMPLETED (28) Display the high temperature
        double highTempDouble = cursor.getDouble(INDEX_WEATHER_MAX_TEMP);
        String hightTemp = SunshineWeatherUtils.formatTemperature(this, highTempDouble);
        mHighView.setText(hightTemp);

//      COMPLETED (29) Display the low temperature
        double lowTempDouble = cursor.getDouble(INDEX_WEATHER_MIN_TEMP);
        String lowTemp = SunshineWeatherUtils.formatTemperature(this, lowTempDouble);
        mLowView.setText(lowTemp);

//      COMPLETED (30) Display the humidity
        float humidityFloat = cursor.getFloat(INDEX_WEATHER_HUMIDITY);
        String humidity = getString(R.string.format_humidity, humidityFloat);
...
//      COMPLETED (31) Display the wind speed and direction
        ...
        float windDirection = cursor.getFloat(INDEX_WEATHER_DEGREE);
...
//      COMPLETED (32) Display the pressure
        float pressureFloat = cursor.getFloat(INDEX_WEATHER_PRESSURE);
        String pressure = getString(R.string.format_pressure, pressureFloat);
